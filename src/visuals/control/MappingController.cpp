...
void MappingController::setup(){
	...
	mapping.addImageTemplate("welcome", "images/welcome.png");
	mapping.addImageTemplate("url", "images/url.png");
...
void MappingController::draw(int projector_id) {
	...
	ofPtr<ofx2DMappingProjector> p = mapping.getControl()->getProjector(projector_id);
